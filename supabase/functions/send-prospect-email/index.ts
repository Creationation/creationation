        ...
        <div style="max-width: 600px; margin: 0 auto; padding: 24px;">
          ...
          <div style="background: #fff; padding: 40px 32px;">
            ...
            <div style="text-align: center; margin-bottom: 8px;">
              <a href="https://wa.me/436702022360" style="display: inline-block; padding: 14px 32px; background: #25D366; color: #fff; text-decoration: none; border-radius: 50px; font-family: Arial, sans-serif; font-size: 14px; font-weight: 600; margin: 0 6px 8px;">💬 ${l.whatsapp}</a>
