        ...
        <div style={{ padding: '16px 24px' }}>
          ...
          {tab === 'score' && (
            <div className="flex flex-col gap-3">
              ...
              <button onClick={handleRescore} disabled={rescoring} style={{ marginTop: 8, padding: '10px 18px', background: '#3B82F6', color: '#fff', border: 'none', borderRadius: 100, fontFamily: ''Outfit', sans-serif', fontSize: 13, fontWeight: 600, cursor: rescoring ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', gap: 6, alignSelf: 'center', opacity: rescoring ? 0.7 : 1 }}>
