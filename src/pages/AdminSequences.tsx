    ...
    <div>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: 16 }}>
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={() => { setSelectedSequence(null); setShowForm(true); setForm({ name: '', description: '', sector: '', language: 'auto', steps: [{ step_number: 1, delay_days: 0, type: 'initial', subject_template: '', body_template: '' }] }); }} style={{ padding: '10px 20px', background: '#2DD4B8', color: '#fff', border: 'none', borderRadius: '100px', fontFamily: "'Outfit', sans-serif", fontSize: 13, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}>
